...
//
//public class EntertainmentCatFragment extends Fragment {
//    String TAG = "EntertainmentCatFragment";
//    private int cat_id = 5;
//    RecyclerView recyclerView;
//    View view;
//
//    class shopsList extends AsyncTask<Void, Void, Void> {
//
//        /* renamed from: com.zamhtech.exer.Fragments.EntertainmentCatFragment$shopsList$2 */
//        class C07972 implements ErrorListener {
//            C07972() {
//            }
//
//            public void onErrorResponse(VolleyError volleyError) {
//                String str = EntertainmentCatFragment.this.TAG;
//                StringBuilder stringBuilder = new StringBuilder();
//                stringBuilder.append("MainActivity Error: ");
//                stringBuilder.append(volleyError.getMessage());
//                Log.e(str, stringBuilder.toString());
//                Toast.makeText(EntertainmentCatFragment.this.getContext(), volleyError.getMessage(), 1).show();
//            }
//        }
//
//        shopsList() {
...
//            fillItemsRecycler(EntertainmentCatFragment.this.recyclerView);
//            return null;
//        }
//
...
//                    String str2 = EntertainmentCatFragment.this.TAG;
//                    StringBuilder stringBuilder = new StringBuilder();
...
//                            }
//                            str = new HotDealsAdapter(EntertainmentCatFragment.this.getContext(), arrayList);
//                            recyclerView.setHasFixedSize(true);
//                            LayoutManager linearLayoutManager = new LinearLayoutManager(EntertainmentCatFragment.this.getContext());
//                            linearLayoutManager.setOrientation(1);
//                            recyclerView.setLayoutManager(linearLayoutManager);
//                            recyclerView.setAdapter(str);
//                            return;
//                        }
//                        Log.i(EntertainmentCatFragment.this.TAG, jSONObject.getString("error_msg"));
//                    } catch (String str3) {
//                        str3.printStackTrace();
//                        Context context = EntertainmentCatFragment.this.getContext();
...
//                    hashMap.put("cat_id", String.valueOf(EntertainmentCatFragment.this.cat_id));
//                    return hashMap;
//                }
//            }, str);
//        }
