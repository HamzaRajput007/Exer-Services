...
//
//public class RetailandServicesCatFragment extends Fragment {
//    String TAG = "RetailandServicesCatFragment";
//    private int cat_id = 6;
//    RecyclerView recyclerView;
//    View view;
//
//    class shopsList extends AsyncTask<Void, Void, Void> {
//
//        /* renamed from: com.zamhtech.exer.Fragments.RetailandServicesCatFragment$shopsList$2 */
//        class C08122 implements ErrorListener {
//            C08122() {
//            }
//
//            public void onErrorResponse(VolleyError volleyError) {
//                String str = RetailandServicesCatFragment.this.TAG;
//                StringBuilder stringBuilder = new StringBuilder();
//                stringBuilder.append("MainActivity Error: ");
//                stringBuilder.append(volleyError.getMessage());
//                Log.e(str, stringBuilder.toString());
//                Toast.makeText(RetailandServicesCatFragment.this.getContext(), volleyError.getMessage(), 1).show();
//            }
//        }
//
//        shopsList() {
...
//            fillItemsRecycler(RetailandServicesCatFragment.this.recyclerView);
//            return null;
//        }
//
...
//                    String str2 = RetailandServicesCatFragment.this.TAG;
//                    StringBuilder stringBuilder = new StringBuilder();
...
//                            }
//                            str = new HotDealsAdapter(RetailandServicesCatFragment.this.getContext(), arrayList);
//                            recyclerView.setHasFixedSize(true);
//                            LayoutManager linearLayoutManager = new LinearLayoutManager(RetailandServicesCatFragment.this.getContext());
//                            linearLayoutManager.setOrientation(1);
//                            recyclerView.setLayoutManager(linearLayoutManager);
//                            recyclerView.setAdapter(str);
//                            return;
//                        }
//                        Log.i(RetailandServicesCatFragment.this.TAG, jSONObject.getString("error_msg"));
//                    } catch (String str3) {
//                        str3.printStackTrace();
//                        Context context = RetailandServicesCatFragment.this.getContext();
...
//                    hashMap.put("cat_id", String.valueOf(RetailandServicesCatFragment.this.cat_id));
//                    return hashMap;
//                }
//            }, str);
//        }
