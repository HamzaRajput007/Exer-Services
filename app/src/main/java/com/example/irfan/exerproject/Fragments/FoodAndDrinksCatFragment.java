...
//
//public class FoodAndDrinksCatFragment extends Fragment {
//    String TAG = "FoodAndDrinksCatFragment";
...
//
//        /* renamed from: com.zamhtech.exer.Fragments.FoodAndDrinksCatFragment$shopsList$2 */
//        class C08012 implements ErrorListener {
//            C08012() {
//            }
//
//            public void onErrorResponse(VolleyError volleyError) {
//                String str = FoodAndDrinksCatFragment.this.TAG;
//                StringBuilder stringBuilder = new StringBuilder();
//                stringBuilder.append("MainActivity Error: ");
//                stringBuilder.append(volleyError.getMessage());
//                Log.e(str, stringBuilder.toString());
//                Toast.makeText(FoodAndDrinksCatFragment.this.getContext(), volleyError.getMessage(), 1).show();
//            }
//        }
//
//        shopsList() {
...
//            fillItemsRecycler(FoodAndDrinksCatFragment.this.recyclerView);
//            return null;
//        }
//
...
//                    String str2 = FoodAndDrinksCatFragment.this.TAG;
//                    StringBuilder stringBuilder = new StringBuilder();
...
//                            }
//                            str = new HotDealsAdapter(FoodAndDrinksCatFragment.this.getContext(), arrayList);
//                            recyclerView.setHasFixedSize(true);
//                            LayoutManager linearLayoutManager = new LinearLayoutManager(FoodAndDrinksCatFragment.this.getContext());
//                            linearLayoutManager.setOrientation(1);
//                            recyclerView.setLayoutManager(linearLayoutManager);
//                            recyclerView.setAdapter(str);
//                            return;
//                        }
//                        Log.i(FoodAndDrinksCatFragment.this.TAG, jSONObject.getString("error_msg"));
//                    } catch (String str3) {
//                        str3.printStackTrace();
//                        Context context = FoodAndDrinksCatFragment.this.getContext();
...
//                    hashMap.put("cat_id", String.valueOf(FoodAndDrinksCatFragment.this.cat_id));
//                    return hashMap;
//                }
//            }, str);
//        }
