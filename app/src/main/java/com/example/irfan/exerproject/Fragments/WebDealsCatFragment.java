...
//
//public class WebDealsCatFragment extends Fragment {
//    String TAG = "WebDealsCatFragment";
...
//
//        /* renamed from: com.zamhtech.exer.Fragments.WebDealsCatFragment$shopsList$2 */
//        class C08162 implements ErrorListener {
//            C08162() {
//            }
//
//            public void onErrorResponse(VolleyError volleyError) {
//                String str = WebDealsCatFragment.this.TAG;
//                StringBuilder stringBuilder = new StringBuilder();
//                stringBuilder.append("MainActivity Error: ");
//                stringBuilder.append(volleyError.getMessage());
//                Log.e(str, stringBuilder.toString());
//                Toast.makeText(WebDealsCatFragment.this.getContext(), volleyError.getMessage(), 1).show();
//            }
//        }
//
//        shopsList() {
...
//            fillItemsRecycler(WebDealsCatFragment.this.recyclerView);
//            return null;
//        }
//
...
//                    String str2 = WebDealsCatFragment.this.TAG;
//                    StringBuilder stringBuilder = new StringBuilder();
...
//                            }
//                            str = new HotDealsAdapter(WebDealsCatFragment.this.getContext(), arrayList);
//                            recyclerView.setHasFixedSize(true);
//                            LayoutManager linearLayoutManager = new LinearLayoutManager(WebDealsCatFragment.this.getContext());
//                            linearLayoutManager.setOrientation(1);
//                            recyclerView.setLayoutManager(linearLayoutManager);
//                            recyclerView.setAdapter(str);
//                            return;
//                        }
//                        Log.i(WebDealsCatFragment.this.TAG, jSONObject.getString("error_msg"));
//                    } catch (String str3) {
//                        str3.printStackTrace();
//                        Context context = WebDealsCatFragment.this.getContext();
...
//                    hashMap.put("cat_id", String.valueOf(WebDealsCatFragment.this.cat_id));
//                    return hashMap;
//                }
//            }, str);
//        }
